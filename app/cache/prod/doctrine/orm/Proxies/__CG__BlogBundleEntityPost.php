...
class Post extends \BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'titre', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'url', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'contenu', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'datePublication');
        }
